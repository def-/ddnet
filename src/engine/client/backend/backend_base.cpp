...
int CCommandProcessorFragment_GLBase::TexFormatToImageColorChannelCount(int TexFormat)
{
...
void *CCommandProcessorFragment_GLBase::Resize(int Width, int Height, int NewWidth, int NewHeight, int Format, const unsigned char *pData)
{
