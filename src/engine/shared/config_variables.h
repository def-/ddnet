...
MACRO_CONFIG_STR(SvWebsocketCert, sv_websocket_cert, 128, "", CFGFLAG_SERVER, "Path to the TLS certificate chain used for websocket connections, enables wss instead of ws (requires sv_websocket_key)")
MACRO_CONFIG_STR(SvWebsocketKey, sv_websocket_key, 128, "", CFGFLAG_SERVER, "Path to the TLS private key used for websocket connections (requires sv_websocket_cert)")
#endif
