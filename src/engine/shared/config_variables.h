...
MACRO_CONFIG_INT(ClMultiServerAlpha, cl_multi_server_alpha, 65, 0, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Visibility of players that are on another observed server (alpha value, 0 invisible, 100 fully visible)")
