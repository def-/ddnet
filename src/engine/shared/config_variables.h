...
MACRO_CONFIG_INT(DbgGfx, dbg_gfx, 0, 0, 3, CFGFLAG_CLIENT, "Show graphic library warnings and errors, if the GPU supports it (0: none, 1: minimal, 2: affects performance, 3: all & verbose")
#ifdef CONF_DEBUG
